...
# SSR helpers for Next.js / SvelteKit / Remix (recommended)
npm install @supabase/ssr

# For Auth UI components (optional)
npm install @supabase/auth-ui-react @supabase/auth-ui-shared
```

> **Note**: `@supabase/auth-helpers-nextjs` and `@supabase/auth-helpers-react` are **deprecated**.
...
#### 2.3 Protected Routes (Next.js Middleware)

```typescript
// middleware.ts — using @supabase/ssr (recommended)
...
| Skill | 何时使用 |
|-------|---------|
| **supabase-gemini-deploy** | Edge Function 部署遇到 401/500/CORS 时的排查手册 |
| **mvp-billing-system** | 基于 Supabase 构建完整计费系统（RPC + 钱包 + 订阅） |
| **stripe-payments** | 简单 Stripe 订阅门控的快速集成 |
| **nextjs-fullstack** | Next.js App Router + Supabase 的全栈开发模式 |
| **saas-quickstart** | 使用 Supabase 快速启动 SaaS 项目 |
